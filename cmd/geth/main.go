...
func init() {
	...
	app.Commands = []cli.Command{
		...
		sub.ImportCommand,
		sub.ExportCommand,
		sub.ImportPreimagesCommand,
		sub.ExportPreimagesCommand,
		sub.RemovedbCommand,
		sub.DumpCommand,
		sub.DumpGenesisCommand,
		// See accountcmd.go:
		sub.AccountCommand,
		sub.WalletCommand,
		// See consolecmd.go:
		...
		javascriptCommand,
		// See misccmd.go:
		sub.MakecacheCommand,
		sub.MakedagCommand,
		sub.VersionCommand,
		sub.VersionCheckCommand,
		sub.LicenseCommand,
		// See config.go
		sub.NewDumpConfigCommand(nodeFlags, rpcFlags),
		// see dbcmd.go
		sub.DbCommand,
...
func geth(ctx *cli.Context) error {
	...
	sub.Prepare(ctx)
	stack, backend := sub.MakeFullNode(ctx, nil)
	defer stack.Close()
