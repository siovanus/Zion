...
func NewDumpConfigCommand(nodeFlags, rpcFlags []cli.Flag) cli.Command {
...
func MakeFullNode(ctx *cli.Context, moduleInitFunc func()) (*node.Node, ethapi.Backend) {
	...
	backend, eth := utils.RegisterEthService(stack, &cfg.Eth, moduleInitFunc)
