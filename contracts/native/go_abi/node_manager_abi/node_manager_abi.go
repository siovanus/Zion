...
var INodeManagerFuncSigs = map[string]string{
	...
	"abec78b7": "updateCommission(address,int256,int256)",
...
//
// Solidity: function createValidator(address consensusAddress, address signerAddress, address proposalAddress, int256 commission, int256 commissionLockEpoch, string desc) returns(bool success)
func (_INodeManager *INodeManagerTransactor) CreateValidator(opts *bind.TransactOpts, consensusAddress common.Address, signerAddress common.Address, proposalAddress common.Address, commission *big.Int, commissionLockEpoch *big.Int, desc string) (*types.Transaction, error) {
	return _INodeManager.contract.Transact(opts, "createValidator", consensusAddress, signerAddress, proposalAddress, commission, commissionLockEpoch, desc)
}

// CreateValidator is a paid mutator transaction binding the contract method 0xb5c42005.
//
// Solidity: function createValidator(address consensusAddress, address signerAddress, address proposalAddress, int256 commission, int256 commissionLockEpoch, string desc) returns(bool success)
func (_INodeManager *INodeManagerSession) CreateValidator(consensusAddress common.Address, signerAddress common.Address, proposalAddress common.Address, commission *big.Int, commissionLockEpoch *big.Int, desc string) (*types.Transaction, error) {
	return _INodeManager.Contract.CreateValidator(&_INodeManager.TransactOpts, consensusAddress, signerAddress, proposalAddress, commission, commissionLockEpoch, desc)
}

// CreateValidator is a paid mutator transaction binding the contract method 0xb5c42005.
//
// Solidity: function createValidator(address consensusAddress, address signerAddress, address proposalAddress, int256 commission, int256 commissionLockEpoch, string desc) returns(bool success)
func (_INodeManager *INodeManagerTransactorSession) CreateValidator(consensusAddress common.Address, signerAddress common.Address, proposalAddress common.Address, commission *big.Int, commissionLockEpoch *big.Int, desc string) (*types.Transaction, error) {
	return _INodeManager.Contract.CreateValidator(&_INodeManager.TransactOpts, consensusAddress, signerAddress, proposalAddress, commission, commissionLockEpoch, desc)
}
...
//
// Solidity: function stake(address consensusAddress) returns(bool success)
func (_INodeManager *INodeManagerTransactor) Stake(opts *bind.TransactOpts, consensusAddress common.Address) (*types.Transaction, error) {
	return _INodeManager.contract.Transact(opts, "stake", consensusAddress)
}

// Stake is a paid mutator transaction binding the contract method 0x26476204.
//
// Solidity: function stake(address consensusAddress) returns(bool success)
func (_INodeManager *INodeManagerSession) Stake(consensusAddress common.Address) (*types.Transaction, error) {
	return _INodeManager.Contract.Stake(&_INodeManager.TransactOpts, consensusAddress)
}

// Stake is a paid mutator transaction binding the contract method 0x26476204.
//
// Solidity: function stake(address consensusAddress) returns(bool success)
func (_INodeManager *INodeManagerTransactorSession) Stake(consensusAddress common.Address) (*types.Transaction, error) {
	return _INodeManager.Contract.Stake(&_INodeManager.TransactOpts, consensusAddress)
}
...
// UpdateCommission is a paid mutator transaction binding the contract method 0xabec78b7.
//
// Solidity: function updateCommission(address consensusAddress, int256 commission, int256 commissionLockEpoch) returns(bool success)
func (_INodeManager *INodeManagerTransactor) UpdateCommission(opts *bind.TransactOpts, consensusAddress common.Address, commission *big.Int, commissionLockEpoch *big.Int) (*types.Transaction, error) {
	return _INodeManager.contract.Transact(opts, "updateCommission", consensusAddress, commission, commissionLockEpoch)
}

// UpdateCommission is a paid mutator transaction binding the contract method 0xabec78b7.
//
// Solidity: function updateCommission(address consensusAddress, int256 commission, int256 commissionLockEpoch) returns(bool success)
func (_INodeManager *INodeManagerSession) UpdateCommission(consensusAddress common.Address, commission *big.Int, commissionLockEpoch *big.Int) (*types.Transaction, error) {
	return _INodeManager.Contract.UpdateCommission(&_INodeManager.TransactOpts, consensusAddress, commission, commissionLockEpoch)
}

// UpdateCommission is a paid mutator transaction binding the contract method 0xabec78b7.
//
// Solidity: function updateCommission(address consensusAddress, int256 commission, int256 commissionLockEpoch) returns(bool success)
func (_INodeManager *INodeManagerTransactorSession) UpdateCommission(consensusAddress common.Address, commission *big.Int, commissionLockEpoch *big.Int) (*types.Transaction, error) {
	return _INodeManager.Contract.UpdateCommission(&_INodeManager.TransactOpts, consensusAddress, commission, commissionLockEpoch)
}
...
// FilterCreateValidator is a free log retrieval operation binding the contract event 0x186b5bf507a69c99caca534de80d21c12c6f8b011f08a85616125b20acb6285e.
//
// Solidity: event CreateValidator(string consensusAddress, string caller, string amount)
...
// WatchCreateValidator is a free log subscription operation binding the contract event 0x186b5bf507a69c99caca534de80d21c12c6f8b011f08a85616125b20acb6285e.
//
// Solidity: event CreateValidator(string consensusAddress, string caller, string amount)
...
// ParseCreateValidator is a log parse operation binding the contract event 0x186b5bf507a69c99caca534de80d21c12c6f8b011f08a85616125b20acb6285e.
//
// Solidity: event CreateValidator(string consensusAddress, string caller, string amount)
...
// FilterStake is a free log retrieval operation binding the contract event 0x35314f02cb99f308f4197c07034e07761009aacc372fc9756592efe2812c90c2.
//
// Solidity: event Stake(string consensusAddress, string caller, string amount)
...
// WatchStake is a free log subscription operation binding the contract event 0x35314f02cb99f308f4197c07034e07761009aacc372fc9756592efe2812c90c2.
//
// Solidity: event Stake(string consensusAddress, string caller, string amount)
...
// ParseStake is a log parse operation binding the contract event 0x35314f02cb99f308f4197c07034e07761009aacc372fc9756592efe2812c90c2.
//
// Solidity: event Stake(string consensusAddress, string caller, string amount)
...
// FilterUnStake is a free log retrieval operation binding the contract event 0xec736e04101ba57f511cb34173e63f6e60c4337c58f0634b6883d7f9b654c6e8.
//
// Solidity: event UnStake(string consensusAddress, string caller, string amount)
...
// WatchUnStake is a free log subscription operation binding the contract event 0xec736e04101ba57f511cb34173e63f6e60c4337c58f0634b6883d7f9b654c6e8.
//
// Solidity: event UnStake(string consensusAddress, string caller, string amount)
...
// ParseUnStake is a log parse operation binding the contract event 0xec736e04101ba57f511cb34173e63f6e60c4337c58f0634b6883d7f9b654c6e8.
//
// Solidity: event UnStake(string consensusAddress, string caller, string amount)
